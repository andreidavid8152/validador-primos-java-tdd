...
public class ValidadorPrimoTest {
    ...
    @Test
    public void testCeroEsPrimo() {
        assertFalse(ValidadorPrimo.esPrimo(0));
    }
    
    @Test
    public void testMenosDosEsPrimo() {
        assertFalse(ValidadorPrimo.esPrimo(-2));
    }

    @Test
    public void testMenosCien() {
        assertFalse(ValidadorPrimo.esPrimo(100));
    }
}